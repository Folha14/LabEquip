...
namespace LabEquip.Models
{
    public class HelperEquipamento : HelperBase
    {
        ...
        public string getEquipamentoMaisAntigo()
        {
            string equipamentoMaisAntigo = "";
            SqlCommand comando = new SqlCommand();
            SqlConnection conexao = new SqlConnection(ConetorHerdado);

            comando.CommandType = CommandType.StoredProcedure;
            comando.Connection = conexao;
            comando.CommandText = "QEquipamento_GetMaisAntigo";
            ...
            {
                DataRow linha = dt.Rows[0];
                equipamentoMaisAntigo = linha["designacao"].ToString() + " (" + linha["IdadeAnos"].ToString() + " anos)";
            }

            return equipamentoMaisAntigo;
        }

        public string getFabricanteTop()
        {
            string fabricanteTop = "";
            SqlCommand comando = new SqlCommand();
            SqlConnection conexao = new SqlConnection(ConetorHerdado);

            comando.CommandType = CommandType.StoredProcedure;
            comando.Connection = conexao;
            comando.CommandText = "QEquipamento_GetFabricanteTop";
            ...
            {
                DataRow linha = dt.Rows[0];
                fabricanteTop = linha["fabricante"].ToString() + " (" + linha["Quantidade"].ToString() + " equipamentos)";
            }

            return fabricanteTop;
        }

        public string getLocalizacaoTop()
        {
            string localizacaoTop = "";
            SqlCommand comando = new SqlCommand();
            SqlConnection conexao = new SqlConnection(ConetorHerdado);

            comando.CommandType = CommandType.StoredProcedure;
            comando.Connection = conexao;
            comando.CommandText = "QEquipamento_GetLocalizacaoTop";
            ...
            {
                DataRow linha = dt.Rows[0];
                localizacaoTop = linha["localizacao"].ToString() + " (" + linha["Quantidade"].ToString() + " equipamentos)";
            }

            return localizacaoTop;
        }
